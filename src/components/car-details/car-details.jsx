    ...
    <div className="w-full min-h-[400px] bg-white p-6 rounded-2xl shadow-lg">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-cars-content-background flex flex-col items-center justify-center rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-cars-text mb-1">
            ₹{car.oneWayPrice}/km
          </p>
          <p className="text-xs text-gray-500">
            {Json["cars-section"]["minimum-distance"]}: 130 km
          </p>
        </div>
        ...
        <div className="bg-cars-content-background flex flex-col items-center justify-center rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500">
            {Json["cars-section"]["minimum-distance"]}: 250 km
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">
            {car.passengers}+ {Json["cars-section"].passengers}
          </span>
        </div>
        <div className="flex items-center gap-2">
          <svg
          ...
          <span className="text-sm text-gray-700">
            {car.baggage} {Json["cars-section"].baggage}
          </span>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        <button
          ...
          className="w-[50%] h-[40px] flex items-center justify-center bg-cars-button-color text-white  rounded-lg font-semibold hover:opacity-90 transition-opacity"
        >
          {Json["cars-section"].button}
        </button>
        <a
          href={`tel:${Json.Navbar.contact.replace(/\s+/g, "")}`}
          className="w-[50%] h-[40px] cursor-pointer flex items-center justify-center bg-white border-2 border-cars-button-color text-cars-button-color  rounded-lg font-semibold hover:bg-cars-button-color hover:text-white transition-colors"
        >
